    ...
    >
      <div className="hm1_baf1_a">
        ...
        <div className="hm1_baf1_1az">
          <DropDown3 tit="Bid Type" id="type" data={bidType} />
          <DropDown2 tit="Category" id="category" data={category} />
          {/* <Textbox2 tit="Start Data" id="dateS" /> */}
          <Textbox2 tit="End Date" id="dateE" />
          <Textbox1
      ...
      <div className="hm1_baf1_a">
        <div className="hm1_baf1_ab">Chose Languages</div>
        <div className="hm1_baf1_1a">
          ...
          <div className="hm1_baf1_1ab">
            <input type="checkbox" onChange={() => settelugu(!telugu)} />
            Telugu
          </div>
        </div>
